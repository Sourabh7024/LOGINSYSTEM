...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  if($numExistRows > 0){
    // $exists=true; Temporary used.
    $showError = "Username Already Exists";
  }
  else{
      // $exists=false; Temporary used.
  ...
  <?php
    if($showAlert){
      echo '<div class="alert alert-sucess alert-dismissible fade show" role="alert">
        <strong>Sucess!</strong> Your account is now created and you can login now.
    ...
    <div class="container my-4">
      ...
      <form action="/loginsystem/signup.php" method="post">
        ...
        <div class="form-group">
          ...
          <input type="password" maxlength="255" class="form-control" id="password" name="password" placeholder="Password">
        </div>
        <div class="form-group">
